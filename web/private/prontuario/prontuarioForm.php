...
<div id="conta">
    <div>
        ...
        <form id='prontuario' class="row g-3 mt-4" action="./private/prontuario/prontuarioFormSave.php" enctype="multipart/form-data" method="post" style="text-align: center !important;">
        ...
        <?php while ($sintoma = $qrySintomas->fetch(PDO::FETCH_ASSOC)) { 
            ...
            <div class="col-5 grupo mx-auto" style="display: flex; flex-direction: row; align-items: center;">
                <div class="form-check form-switch " style="padding-left: 0px !important;">
                    <input class="form-check-input" type="checkbox" id="<?= $identificadorSintoma ?>" name="<?= $identificadorSintoma ?>" value="<?= $sintoma['codsin'] ?>">
                ...
                <select class="form-select form-select-sm" style="width: 100%;" aria-label=".form-select-sm" id="<?= $identificadorIntensidade ?>" name="<?= $identificadorIntensidade ?>">
